...
public class ResponseHandler {
	...
	public static ResponseEntity<List<AuthPer>> generateListResponseforAuthPer(List<AuthPer> list, HttpStatus status) {
		// TODO Auto-generated method stub
		return new ResponseEntity<List<AuthPer>>(list, status);
	}
