...
public interface CourseRepo extends JpaRepository<Course, Integer> {
	...
	@Query(value = "select * from teacher_course where courseid IN (select courseid from public.\"teacher_course_institutionid\" where institution_id=?1)", nativeQuery = true)
