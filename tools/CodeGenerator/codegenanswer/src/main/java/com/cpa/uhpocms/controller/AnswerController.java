...
public class AnswerController {
	...
	public ResponseEntity<Object> createAnswer(@RequestBody Answer answer) throws CPException {
		...
		try {
			...
			Answer toCheckAnswer = answerService.getAnswerById(answer.getAnswerId());
	...
	public ResponseEntity<Object> getAnswerById(@PathVariable("id") String id)
			throws CPException {
	...
	public ResponseEntity<Object> deleteAnswerById(@PathVariable("id") String id) throws CPException {
